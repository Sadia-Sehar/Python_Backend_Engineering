...
print(next(g))
print(next(g)) #it forgets previous values as it computes next ones
print(next(g))
print(next(g))
print(next(g))
print(next(g)) #can't print anything

numbers=(n for n in range(5))
print(list(numbers))
print(list(numbers)) #[] because a generator is consumed as you use it